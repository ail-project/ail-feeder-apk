...
def generate_lmdb_report(mode, bk, hk, filter_certificate, scrapdb, huntdb, baselinedb, certificatessha256, filter_publisher, bfpath, case, homefolder):
            ...
            for file in files:
                if file.endswith('.apk'):
                    ...
                    with open(bfpath, 'wb') as f:
                        if (mode == "baselining") and (certificates[0]['sha256'] in filter_certificate):
